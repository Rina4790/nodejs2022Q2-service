...
export class FavsService {
  ...
  async addTrack(id: string) {
    valide(id);
    const findTrack = await this.tracksService.getById(id);
  ...
  async addAlbom(id: string) {
    valide(id);
    const findAlbum = await this.albumsService.getById(id)
  ...
  async addArtist(id: string) {
    valide(id);
	  const findArtist = await this.artistsService.getById(id)
